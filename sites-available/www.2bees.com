server {
    listen   443 ssl spdy;
    server_name www.2bees.com;
    ssl on;
    ssl_session_timeout 5m;
    ssl_stapling on;
    ssl_certificate        /etc/ssl/2bees/2bees.com.crt;
    ssl_certificate_key    /etc/ssl/2bees/2bees.com.key;
...
#    }
    ...
    access_log /home/www/shared/log/www.2bees.com-access.log;
    error_log /home/www/shared/log/www.2bees.com-error.log;
